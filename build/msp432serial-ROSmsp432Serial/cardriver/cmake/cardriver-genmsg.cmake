...
message(STATUS "cardriver: 1 messages, 0 services")

set(MSG_I_FLAGS "-Icardriver:/home/ros/catkin_rsomer2/src/msp432serial-ROSmsp432Serial/cardriver/msg;-Istd_msgs:/opt/ros/kinetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/ros/catkin_rsomer2/src/msp432serial-ROSmsp432Serial/cardriver/msg/infrared.msg" NAME_WE)
add_custom_target(_cardriver_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "cardriver" "/home/ros/catkin_rsomer2/src/msp432serial-ROSmsp432Serial/cardriver/msg/infrared.msg" ""
)
...
_generate_msg_cpp(cardriver
  "/home/ros/catkin_rsomer2/src/msp432serial-ROSmsp432Serial/cardriver/msg/infrared.msg"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/cardriver)
  install(CODE "execute_process(COMMAND \"/usr/bin/python\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/cardriver\")")
  # install generated code
  install(
